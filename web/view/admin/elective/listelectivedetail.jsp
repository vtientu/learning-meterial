        ...
        <main class="ttr-wrapper">
            <div class="container-fluid">
                <div class="db-breadcrumb">
                    <h4 class="breadcrumb-title">View Elective Detail</h4>
                    <ul class="db-breadcrumb-list">
                        <li><a href="#"><i class="fa fa-home"></i>Home</a></li>
                        <li>View Elective Detail</li>
                    </ul>
                </div>
                <div class="row">
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tr>
                                    <td class="col-md-4">Elective Subject:</td>
                                    <td class="col-md-8">${elective.electiveNameVN}</td>

                                </tr>
                                <tr>
                                    <td class="col-md-4">Name:</td>
                                    <td class="col-md-8">${elective.electiveNameEN}</td>

                                </tr>
                                <tr>
                                    <td class="col-md-4">Note:</td>
                                    <td class="col-md-8">${elective.note}</td>
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <th style="font-weight: bold" class=" text-light col-lg-10">Subject Name</th>
                                </thead>
                    ...
                    <a href="addelective"><button type="button" class="btn btn-success">Add elective</button></a>
