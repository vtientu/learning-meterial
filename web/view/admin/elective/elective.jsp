                    ...
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tr>
                                    <td class="col-md-4">CurriCulumID</td>
                                    <td class="col-md-8">1460</td>

                                </tr>
                                <tr>
                                    <td class="col-md-4">CurriCulumCode</td>
                                    <td class="col-md-8">${curriculum.curriculumCode}</td>

                                </tr>
                                <tr>
                                    <td class="col-md-4">CurriCulumName</td>
                                    <td class="col-md-8">${curriculum.curriculumNameEN} ${curriculum.curriculumNameVN}</td>
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <th style="font-weight: bold" class=" text-light col-lg-2">Elective ID</th>
                                <th style="font-weight: bold" class=" text-light col-lg-5">Elective Name</th>
                                <th style="font-weight: bold" class=" text-light col-lg-5">Subject</th>
                                </thead>
                                <c:forEach items="${liste}" var="e">
                                    <tbody>
                                    <td>${e.electiveID}</td>
                                    <td><a href="viewelectivedetail?electiveID=${e.electiveID}">${e.electiveNameEN}</a></td>
                                    <td>${e.electiveNameVN}</td>
                                    ...
                                    <a href="addelective?addtype=1"><button type="button" class="btn btn-success">Add elective</button></a>
