<%-- 
    Document   : syllabus-view
    Created on : Feb 16, 2023, 11:49:22 PM
    Author     : tient
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="../assets/assets-admin/images/favicon.png" />
        ...
        <!--[if lt IE 9]>
        <script src="../assets/assets-admin/js/html5shiv.min.js"></script>
        <script src="../assets/assets-admin/js/respond.min.js"></script>
        <![endif]-->
            ...
            <div class="ttr-header-wrapper">
                ...
                <div class="ttr-logo-box">
                    <div>
                        <a href="index.html" class="ttr-logo">
                            <img alt="" class="ttr-logo-mobile" src="../assets/assets-admin/images/logo-mobile.png" width="30" height="30">
                ...
                <div class="ttr-header-right ttr-with-seperator">
                    ...
                    <ul class="ttr-header-navigation">
                        ...
                        <li>
                            <a href="#" class="ttr-material-button ttr-submenu-toggle"><span class="ttr-user-avatar"><img alt="" src="../assets/assets-admin/images/testimonials/pic3.jpg" width="32" height="32"></span></a>
                            <div class="ttr-header-submenu">
                                <ul>
                            ...
                            <div class="widget-inner">
                                <div class="card-courses-list bookmarks-bx">
                                    <div class="card-courses-media">
                                        <img src="../assets/assets-admin/images/courses/pic6.jpg" alt=""/>
                                    </div>
                                ...
                                <div class="card-courses-list bookmarks-bx">
                                    <div class="card-courses-media">
                                        <img src="../assets/assets-admin/images/courses/pic7.jpg" alt=""/>
                                    </div>
                                    <div class="card-courses-full-dec">
                                        <div class="card-courses-title">
                                            <h4 class="m-b5">Become a PHP Master and Make Money</h4>
                                ...
                                <div class="card-courses-list bookmarks-bx">
                                    <div class="card-courses-media">
                                        <img src="../assets/assets-admin/images/courses/pic8.jpg" alt=""/>
                                    </div>
                                    <div class="card-courses-full-dec">
                                        <div class="card-courses-title">
                                            <h4 class="m-b5">Become a PHP Master and Make Money</h4>
                                ...
                                <div class="card-courses-list bookmarks-bx">
                                    <div class="card-courses-media">
                                        <img src="../assets/assets-admin/images/courses/pic9.jpg" alt=""/>
                                    </div>
                                    <div class="card-courses-full-dec">
                                        <div class="card-courses-title">
                                            <h4 class="m-b5">Become a PHP Master and Make Money</h4>
