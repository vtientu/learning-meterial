                    ...
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <th style="font-weight: bold" class=" text-light col-lg-2">ComboName</th>
                                <th style="font-weight: bold" class=" text-light col-lg-3">isActive</th>
                                <th style="font-weight: bold" class=" text-light col-lg-1">Note</th>
                                ...
                                <tbody>
                                    <c:forEach items="${list}" var="clist">
                                        <tr>
                                            <td>${clist.comboID}</td>
                                            <td><a href="combodetailadmin?comboID=${clist.comboID}">${clist.comboName}</a></td>
                                            <td><a href="">${clist.isActive==1?"Active":"unactive"}</a></td>
                                            <td><a>${clist.note}
                                                </a></td>
                                            <td><a href="editcombo?comboID=${clist.comboID}"><i class="fa fa-pencil-square-o" aria-hidden="true" style='font-size:26px;color:red'></i></a>
