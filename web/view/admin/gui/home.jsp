<%-- 
    Document   : home
    Created on : Feb 22, 2023, 1:32:45 PM
    Author     : tient
--%>
                                    ...
                                    <ul>
                                        <li>
                                            <span class="new-users-pic">
                                                <img src="../assets/assets-admin/images/testimonials/pic1.jpg" alt=""/>
                                            </span>
                                        ...
                                        <li>
                                            <span class="new-users-pic">
                                                <img src="../assets/assets-admin/images/testimonials/pic2.jpg" alt=""/>
                                            </span>
                                            <span class="new-users-text">
                                        ...
                                        <li>
                                            <span class="new-users-pic">
                                                <img src="../assets/assets-admin/images/testimonials/pic3.jpg" alt=""/>
                                            </span>
                                            <span class="new-users-text">
