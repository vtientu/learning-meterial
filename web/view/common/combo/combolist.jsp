                            ...
                            <div  id="list-items">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-8">${curriculum.curID}</td>
                                ...
                                <table class="table">
                                    ...
                                    <th style="font-weight: bold" class=" text-light col-lg-2">Combo ID</th>
                                    <th style="font-weight: bold" class=" text-light col-lg-5">Combo Name</th>
                                    </thead>
                                    <c:forEach items="${combolist}" var="list">
                                        <tbody>
                                        <td>${list.comboID}</td>
                                        <td><a href="combodetail?comboID=${list.comboID}">${list.comboName}</a></td>
                                        </tbody>
                                    </c:forEach>
                                </table>
